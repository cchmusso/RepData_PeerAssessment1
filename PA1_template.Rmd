...
https://github.com/BigDataArjun/RepData_PeerAssessment1/blob/master/PA1_template.Rmd
...
setwd("~/workspace/R/coursera/JohnHopkins/ReproducibleResearch/")
...
For any NA values, we fill in with te calculated number for that interval
```{r}
library(zoo)
actFilled <- act
